class satelites:
    ...
    def GetLocation(self,r1,r2,r3):
        ...
        #verifico distancias
        if self.__distacia_kenobi == 0 or self.__distacia_skywalker == 0 or self.__distacia_sato == 0:
        ...
        for i in range(cant_elementos_maxima):
            if len(str(msg1[i])) > 0:
                ...
                for x in range(i, cant_elementos_maxima):
                    if len(str(msg1[x])) > 0:
                        return "El mensaje no puede ser descifrado"
        ...
        try:
            ...
            if 'satellites' in str(data):
                ...
                if len(mensaje_kenobi) == 0 or len(mensaje_skywalker) == 0 or len(mensaje_sato) == 0:
                    raise ValueError('Unos de los mensaje de lo satelites estan vacios')
